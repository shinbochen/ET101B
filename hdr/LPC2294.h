...
/* External Interrupts */
/* 外部中断控制寄存器 */
#define EXTINT          (*((volatile char *) 0xE01FC140))
#define EXTWAKE         (*((volatile char *) 0xE01FC144))
#define EXTMODE         (*((volatile char *) 0xE01FC148))      /* no in lpc210x*/
#define EXTPOLAR        (*((volatile char *) 0xE01FC14C))      /* no in lpc210x*/

/* SMemory mapping control. */
/* 内存remap控制寄存器 */
#define MEMMAP          (*((volatile char *) 0xE01FC040))

/* Phase Locked Loop (PLL) */
/* PLL控制寄存器 */
#define PLLCON          (*((volatile char *) 0xE01FC080))
#define PLLCFG          (*((volatile char *) 0xE01FC084))
#define PLLSTAT         (*((volatile unsigned short*) 0xE01FC088))
#define PLLFEED         (*((volatile char *) 0xE01FC08C))

/* Power Control */
/* 功率控制寄存器 */
#define PCON            (*((volatile char *) 0xE01FC0C0))
#define PCONP           (*((volatile unsigned long *) 0xE01FC0C4))

/* VPB Divider */
/* VLSI外设总线（VPB）分频寄存器 */
#define VPBDIV          (*((volatile char *) 0xE01FC100))

/* Memory Accelerator Module (MAM) */
/* 存储器加速模块 */
#define MAMCR           (*((volatile char *) 0xE01FC000))
#define MAMTIM          (*((volatile char *) 0xE01FC004))
...
#define U0RBR           (*((volatile char *) 0xE000C000))
#define U0THR           (*((volatile char *) 0xE000C000))
#define U0IER           (*((volatile char *) 0xE000C004))
#define U0IIR           (*((volatile char *) 0xE000C008))
#define U0FCR           (*((volatile char *) 0xE000C008))
#define U0LCR           (*((volatile char *) 0xE000C00C))
#define U0LSR           (*((volatile char *) 0xE000C014))
#define U0SCR           (*((volatile char *) 0xE000C01C))
#define U0DLL           (*((volatile char *) 0xE000C000))
#define U0DLM           (*((volatile char *) 0xE000C004))

/* Universal Asynchronous Receiver Transmitter 1 (UART1) */
/* 通用异步串行口1(UART1)的特殊寄存器 */
#define U1RBR           (*((volatile char *) 0xE0010000))
#define U1THR           (*((volatile char *) 0xE0010000))
#define U1IER           (*((volatile char *) 0xE0010004))
#define U1IIR           (*((volatile char *) 0xE0010008))
#define U1FCR           (*((volatile char *) 0xE0010008))
#define U1LCR           (*((volatile char *) 0xE001000C))
#define U1MCR           (*((volatile char *) 0xE0010010))
#define U1LSR           (*((volatile char *) 0xE0010014))
#define U1MSR           (*((volatile char *) 0xE0010018))
#define U1SCR           (*((volatile char *) 0xE001001C))
#define U1DLL           (*((volatile char *) 0xE0010000))
#define U1DLM           (*((volatile char *) 0xE0010004))

/* I2C (8/16 bit data bus) */
/* 芯片间总线（I2C）的特殊寄存器 */
#define I2CONSET        (*((volatile char *) 0xE001C000))
#define I2STAT          (*((volatile char *) 0xE001C004))
#define I2DAT           (*((volatile char *) 0xE001C008))
#define I2ADR           (*((volatile char *) 0xE001C00C))
#define I2SCLH          (*((volatile unsigned short *) 0xE001C010))
#define I2SCLL          (*((volatile unsigned short *) 0xE001C014))
#define I2CONCLR        (*((volatile char *) 0xE001C018))

/* SPI (Serial Peripheral Interface) */
/* SPI总线接口的特殊寄存器 */
        /* only for lpc210x*/
#define SPI_SPCR        (*((volatile char *) 0xE0020000))
#define SPI_SPSR        (*((volatile char *) 0xE0020004))
#define SPI_SPDR        (*((volatile char *) 0xE0020008))
#define SPI_SPCCR       (*((volatile char *) 0xE002000C))
#define SPI_SPINT       (*((volatile char *) 0xE002001C))

#define S0PCR           (*((volatile char *) 0xE0020000))      /* no in lpc210x*/
#define S0PSR           (*((volatile char *) 0xE0020004))      /* no in lpc210x*/
#define S0PDR           (*((volatile char *) 0xE0020008))      /* no in lpc210x*/
#define S0PCCR          (*((volatile char *) 0xE002000C))      /* no in lpc210x*/
#define S0PINT          (*((volatile char *) 0xE002001C))      /* no in lpc210x*/

#define S1PCR           (*((volatile char *) 0xE0030000))      /* no in lpc210x*/
#define S1PSR           (*((volatile char *) 0xE0030004))      /* no in lpc210x*/
#define S1PDR           (*((volatile char *) 0xE0030008))      /* no in lpc210x*/
#define S1PCCR          (*((volatile char *) 0xE003000C))      /* no in lpc210x*/
#define S1PINT          (*((volatile char *) 0xE003001C))      /* no in lpc210x*/
...
// ------------------------
#define ADCR0		(*((volatile unsigned long *) 0xE0034000))
#define ADDR01		(*((volatile unsigned long *) 0xE0034014))
...
/* Real Time Clock */
/* 实时时钟的特殊寄存器 */
#define ILR             (*((volatile char *) 0xE0024000))
#define CTC             (*((volatile unsigned short*) 0xE0024004))
#define CCR             (*((volatile char *) 0xE0024008))
#define CIIR            (*((volatile char *) 0xE002400C))
#define AMR             (*((volatile char *) 0xE0024010))
#define CTIME0          (*((volatile unsigned long *) 0xE0024014))
#define CTIME1          (*((volatile unsigned long *) 0xE0024018))
#define CTIME2          (*((volatile unsigned long *) 0xE002401C))
#define SEC             (*((volatile char *) 0xE0024020))
#define MIN             (*((volatile char *) 0xE0024024))
#define HOUR            (*((volatile char *) 0xE0024028))
#define DOM             (*((volatile char *) 0xE002402C))
#define DOW             (*((volatile char *) 0xE0024030))
#define DOY             (*((volatile unsigned short*) 0xE0024034))
#define MONTH           (*((volatile char *) 0xE0024038))
#define YEAR            (*((volatile unsigned short*) 0xE002403C))
#define ALSEC           (*((volatile char *) 0xE0024060))
#define ALMIN           (*((volatile char *) 0xE0024064))
#define ALHOUR          (*((volatile char *) 0xE0024068))
#define ALDOM           (*((volatile char *) 0xE002406C))
#define ALDOW           (*((volatile char *) 0xE0024070))
#define ALDOY           (*((volatile unsigned short*) 0xE0024074))
#define ALMON           (*((volatile char *) 0xE0024078))
...
/* Watchdog */
/* 看门狗的特殊寄存器 */
#define WDMOD           (*((volatile char *) 0xE0000000))
#define WDTC            (*((volatile unsigned long *) 0xE0000004))
#define WDFEED          (*((volatile char *) 0xE0000008))
