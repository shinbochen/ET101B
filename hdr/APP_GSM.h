...
#define  		TASK_GSMDATA_RECEIVE_STK_SIZE         					60//40//128		
// 串口数据接收后的处理的任务堆栈空间大小(512 * 4字节包括寄存器)
#define  		TASK_GSMAPP_STK_SIZE  				  					440//400//292		

// 模块上电启动时,间隔2S
#define			GSM_ATTIME200_CHECK										200
...
//===参数初始值====================================================================================
#if (TOM || FRANK_WU || LIUYAN ) 
	#if( FRANK_WU || LIUYAN )
		#define	C_ServerIP		"203.86.9.28"
	#else
		#define	C_ServerIP		"211.154.149.98"
	#endif 
	#if( LIUYAN )
		#define C_APN			"myMTN"	
		#define C_APNUser		"MTN"
		#define	C_APNPsd		"MTN"
	#else
		#define C_APN			"web.gprs.mtnnigeria.net"	
		#define C_APNUser		"web"
		#define	C_APNPsd		"web"
	#endif
#else
	#if( JORGE_AUTOFUEL )
		#define	C_ServerIP		"190.82.104.250"
		#define C_APN			"web.temovil.cl"	
		#define C_APNUser		"web"
		#define	C_APNPsd		"web"
	#else
		#define	C_ServerIP		"203.86.9.28"
...
#if ( HW_MC323|| HW_EM200 )
#define	 C_MaterNo				"13751149475"
#else
#define	 C_MaterNo				"669475"
#endif 
...
#if( JORGE_AUTOFUEL )
	#define			C_CommMode		COMM_USE_GPRS		//UDP模式
	#define			C_CBMode		CB_BYTIME
#else
	#define			C_CommMode		0x00				//GSM	
	#define			C_CBMode		CB_STOP				//停止上传
#endif
