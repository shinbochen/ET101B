...
enum{
	...
	//  温度报警值
	AL_TEMPERATUREDATA   = 0x100000,
	//  撞车报警
	AL_CRASH_ALARM		 = 0x200000
};
...
//  GPS未定位报警
#define		AL_IsCrashAlarm()	 	 (g_stDeviceState.m_nALState &   AL_CRASH_ALARM )	
#define		AL_SetCrashAlarm( )	 	 (g_stDeviceState.m_nALState |=  AL_CRASH_ALARM )
#define		AL_ClrCrashAlarm( )	 	 (g_stDeviceState.m_nALState &= ~AL_CRASH_ALARM )						
...
//	入界报警 
#define		AL_IsEnableEnterGEOFence( )	  (g_stAlarmSetup.m_nAlarmEnable &  AL_ENT_FENCING ) 
#define		AL_EnableEnterGEOFence( )	  (g_stAlarmSetup.m_nAlarmEnable |= AL_ENT_FENCING ) 	
#define		AL_DisableEnterGEOFence( )	  (g_stAlarmSetup.m_nAlarmEnable &=~AL_ENT_FENCING )
//	出界报警
#define		AL_IsEnableLeaveGEOFence( )   (g_stAlarmSetup.m_nAlarmEnable  &  AL_LEAVOMG_FENCING ) 
#define		AL_EnableLeaveGEOFence( )     (g_stAlarmSetup.m_nAlarmEnable  |= AL_LEAVOMG_FENCING ) 
#define		AL_DisableLeaveGEOFence( )    (g_stAlarmSetup.m_nAlarmEnable  &=~AL_LEAVOMG_FENCING ) 
...
//  撞车报警
#define		AL_IsEnableCrashAlarm()		 (g_stAlarmSetup.m_nAlarmEnable &  AL_CRASH_ALARM )	
#define		AL_EnableCrashAlarm( )	 	 (g_stAlarmSetup.m_nAlarmEnable |= AL_CRASH_ALARM )
#define		AL_DisableCrashAlarm( )	 	 (g_stAlarmSetup.m_nAlarmEnable &=~AL_CRASH_ALARM )	
